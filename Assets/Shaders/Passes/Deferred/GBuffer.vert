...
layout(location = 1)out vec4 outWorldTangent;
...
layout(location = 5)flat out uint outObjectFlags;

void main()
{
    uint objectIndex = uInstanceObjectIndices[uint(gl_BaseInstance) + uint(gl_InstanceID)];
